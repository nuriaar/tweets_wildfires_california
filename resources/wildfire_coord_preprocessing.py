'''
Preprocessing of wildfire coordinate data for map visualization.
'''
...
def preprocess_wildfire_coord_data():
    '''
    Create new geojson file with preprocessed wildfire coordinate data to input
    map visualization.
    '''
    ...
    # Select only large wildfires for visualization
    ...
    # Create fire_season variable
    coord_data['fire_season'] = coord_data.apply(is_fire_season, axis = 1)

    # Reduce coordinate data to improve efficiency
